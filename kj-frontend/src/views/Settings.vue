          ...
          <div class="user-info-item">
            ...
            <el-form-item prop="email">
              <el-input
                ...
                class="w-50 m-3"
                size="large"
                placeholder="请输入小老弟的电子邮箱"
                v-show="isInEditMode"
              />
            </el-form-item>
          </div>
					<div class="user-info-item">
            <span class="user-info-label">微信账号</span>
            <span class="user-info-value" v-show="!isInEditMode">{{
              wechatAccount
            }}</span>
            <el-form-item prop="wechatAccount">
              <el-input
                v-model="ruleForm.wechatAccount"
                type="wechatAccount"
                class="w-50 m-3"
                size="large"
                placeholder="请输入小老弟的电子邮箱"
